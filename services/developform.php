     ...
     <main>
        <div class="hadcon">
          <img src="/project22/icons/webdev.png" alt="">&nbsp;
            <h2 align="center">FILL ALL DETAILS FOR YOUR FUTURE WEBSITE!</h2>
             </div>
                 

            <div id="formdiv">
                <form action="webdevformserver.php" method="post">
                    <div>
                        Website type :
        ...
        <input type="radio" name="webtype" value="Other" id=""> Other
              ...
              <input type ="radio" name="webstyle" value="Simple but aesthatic"> Simple but aesthatic
                    ...
                    <textarea name="webtypeinfo" id="txtbox" cols="50" rows="10" placeholder="Insert details about your buisness type..."></textarea>
                      </div>
        <br>
          <div>
            ...
            <textarea name="websitedetails" id="txtbox" cols="50" rows="10" placeholder="Write a wish of your website fetures... "></textarea>
