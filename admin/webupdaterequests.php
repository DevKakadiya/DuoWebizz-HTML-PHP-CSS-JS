...
<body>
    ...
    <div class="bar">
        <ul>
            <li ><a href="admin.php">Developer Requests</a></li>
            <li ><a href="webdevelopmentrequest.php">Web Developement Requests </a></li>
            <li id="dash"><a href="webupdaterequests.php">Web Updates Requests </a></li>
     ...
     <div class="maincontent">
        <?php
             ...
             $sql="SELECT * FROM `securityupdate`";
        ...
        ?>
         <table >
                <tr>
                    <th>Name</th><th>Mail</th><th>Type Of Buisness</th><th>Frontend Languages</th><th>Backend languages </th><th>Templates</th><th>Website details</th><th>Delete</th>
                </tr>
                <?php
                if($num>0){
                ...
                <?php     ?><td><?php echo $row['Name']?></td>
                    ...
                    <td><?php echo $row['Type of buisness']?></td>
                    <td><?php echo $row['Frontendlang']?></td>
                    <td><?php echo $row['Backendlang']?></td>
                    <td><?php echo $row['templates']?></td>
                    <td><?php echo $row['Website details']?></td>
                    <td><a href="dltwebupdate.php?ID='<?php echo $row['Mail']?>'" > <button  id="dlt">Delete</button></a></td>
                </tr>
                <?php
                }
