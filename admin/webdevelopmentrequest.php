...
<body>
    ...
    <div class="bar">
        <ul>
            ...
            <li id="dash"><a href="webdevelopmentrequest.php">Web Developement Requests </a></li>
     ...
     <div class="maincontent">
        ...
        ?>
         ...
         <table >
                <tr>
                    <th>Name</th><th>Mail</th><th>Website Type</th><th>Web Style</th><th>Business Info </th><th>Web Fetures</th><th>Delete</th>
                </tr>
                <?php
                if($num>0){
                ...
                <?php     ?><td><?php echo $row['Name']?></td>
                    ...
                    <td><?php echo $row['Website Type']?></td>
                    <td><?php echo $row['Web Style']?></td>
                    <td><?php echo $row['Buisness info']?></td>
                    <td><?php echo $row['Web Fetures']?></td>
                 
                    <td><a href="dltwebdevlopment.php?ID='<?php echo $row['Mail']?>'" > <button  id="dlt">Delete</button></a></td>
                </tr>
               <?php
                }
